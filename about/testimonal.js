...
window.addEventListener("scroll", () => {
  ...
  function showInfo(item) {
    showDiv.querySelector(".show-img img").src = item.querySelector(
      ".client-thumbnail img"
    ).src;
    showDiv.querySelector(".show-name").innerHTML =
      item.querySelector(".client-name").innerHTML;
    showDiv.querySelector(".show-designation").innerHTML = item.querySelector(
      ".client-designation"
    ).innerHTML;
    showDiv.querySelector(".show-description").innerHTML = item.querySelector(
      ".client-description"
    ).innerHTML;
    setActiveTab(item);
  }
